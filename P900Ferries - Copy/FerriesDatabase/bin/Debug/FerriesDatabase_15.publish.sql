...
AS 
BEGIN 
SELECT  FerryId, Description, CostPerPerson, CostPerVehicle, s.RowVersion, l.Name, l.LocationId,
        DepartureDay, DepartureTime, ArrivalDay, ArrivalTime, s.ScheduleId, ss.ScheduleId,
        ScheduleStopId
        
FROM    dbo.Schedule s
INNER JOIN dbo.ScheduleStop ss
ON s.ScheduleId = ss.ScheduleStopId

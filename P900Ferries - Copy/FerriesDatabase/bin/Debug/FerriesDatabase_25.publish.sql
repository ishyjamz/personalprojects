...
GO
PRINT N'Altering Procedure [dbo].[usp_Journeys_ListSearch]...';
...
\*===========================================================================*/
ALTER PROCEDURE dbo.usp_Journeys_ListSearch
@LocationFrom INT,
@LocationTo INT,
@DateFrom TINYINT,
@DepartingTime TIME
...
AS 
BEGIN
SELECT c.[Name] AS CompanyName, f.[Name] AS FerryName, s.ScheduleId AS ScheduleId, l2.ArrivalDay AS ArrivalDay, l2.ArrivalTime AS ArrivalTime
FROM

...
GO
PRINT N'Creating Procedure [dbo].[usp_ScheduleStop_GetById]...';
...
\*===========================================================================*/
CREATE PROCEDURE dbo.usp_ScheduleStop_GetById (
@ScheduleStopId INT)

AS 
BEGIN 
SELECT  ScheduleId, LocationId, DepartureTime, DepartureDay, ArrivalDay, ArrivalTime
